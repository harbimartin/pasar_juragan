...
class Menu {
    public static function getMenu() {
        ...
        $menu = [
            ['name' => 'Profile User', 'key' => 'dashboard.profile-user', 'icon' => 2],
            ['name' => 'Profile Perusahaan', 'key' => 'dashboard.profile-company', 'icon' => 2],
            ...
            ['name' => 'Juragan Gudang', 'key' => 'dashboard.juragan-gudang', 'icon' => 1, 'children' => [
                ...
                ['name' => 'Daftar Gudang Juragan', 'key' => 'dashboard.juragan-gudang', 'icon' => 2],
                
                ['name' => 'Kelola Gudang', 'key' => 'dashboard.juragan-gudang', 'icon' => 2, 'children' => [
                    ['name' => 'Tambah Gudang', 'key' => 'dashboard.juragan-gudang', 'icon' => 2],
                    ['name' => 'List Gudang', 'key' => 'dashboard.juragan-gudang', 'icon' => 2]
                ]]
            ]],
