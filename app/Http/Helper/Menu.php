    ...
    public static function getMenu() {
        ...
        $menu = [
            ...
            ['name' => 'Juragan Gudang', 'key' => 'dashboard.juragan-gudang', 'icon' => 1, 'children' => [
                ...
                ['name' => 'Kelola Gudang', 'key' => 'dashboard.warehouse', 'icon' => 2, 'children' => [
                    ['name' => 'Tambah Gudang', 'key' => 'dashboard.warehouse.add', 'icon' => 2],
                    ['name' => 'List Gudang', 'key' => 'dashboard.warehouse', 'icon' => 2]
                ]]
            ]],
