    ...
    <section class="bg-white">
        <div class="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-28 lg:grid-cols-12 h-screenq">
            <div class="place-self-center mr-auto lg:col-span-7">
                <h1 class="mb-4 max-w-2xl text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl">Platform untuk Pelayanan Logistik Perusahaan</h1>
                <p class="mb-6 max-w-2xl font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">Dari penyimpanan, checkout, pengiriman internasional mempercayai Juragan sebagai ahlinya.</p>
                <a href="#" class="inline-flex justify-center items-center py-3 px-5 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300">
                    Mulai Sekarang
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="https://media.istockphoto.com/photos/world-map-with-logistic-network-distribution-logistic-and-transport-picture-id1025834892" alt="mockup">
            </div>
        </div>
    </section>
    ...
    <section class="bg-white">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-32">
            ...
            <div class="grid grid-cols-3 gap-8 text-gray-500 sm:gap-12 md:grid-cols-4 lg:grid-cols-4">
                ...
                <div class="justify-center text-center">
                    <svg class="mx-auto" height="46" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-truck" viewBox="0 0 16 16">
            ...
            <div class="grid grid-cols-3 gap-8 text-gray-500 sm:gap-8 md:grid-cols-4 lg:grid-cols-4">
                <div class="bg-white shadow-lg group cursor-pointer flex flex-col">
                    <div class="px-8 pt-4 flex-grow">
                        ...
                        <div class="py-4">
                            Cepat, mudah, dan fleksibel. Temukan tarif terendah dan kirimkan semua produk Anda dalam sekejap.
                        </div>
                    </div>
                ...
                <div class="bg-white shadow-lg group cursor-pointer flex flex-col">
                    <div class="px-8 pt-4 flex-grow">
                        ...
                        <div class="py-4">
                            Kami menyediakan rangkaian solusi pergudangan yang lengkap dan sesuai untuk semua kebutuhan bisnis Anda.
                        </div>
                    </div>
                    <div class="py-4 group-hover:bg-gray-200 transition px-8">
                        Lihat Detail Produk
      ...
      <section class="bg-white">
        <div class="py-12 px-4 mx-auto max-w-screen-xl sm:py-24 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
                ...
                <p class="mb-6 text-gray-500 md:text-lg">Gunakan Fitur Juragan untuk memulai. Tanpa persyaratan Kartu Kredit.</p>
                <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none">Daftar Akun Baru</a>
                <p class="mt-12 text-gray-500 md:text-md">Sudah punya Akun ?
                    <a href="#" class="underline font-medium py-2.5 mr-2 mb-2 hover:text-blue-800">Sign In.</a>
                </p>
            </div>
        </div>
    </section>
