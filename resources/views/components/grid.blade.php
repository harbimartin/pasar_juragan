<div class="md:px-6">
    <div class="md:rounded-lg shadow mt-4 mb-8 py-4 px-2 md:px-6 bg-white">
        @isset($title)
            <div class="border-b text-lg md:text-2xl pb-2 border-gray-200 mb-2 md:mb-5">
                {{ $title }}
            </div>
        @endisset
        @if ($tool)
    ...
    <div class="flex flex-col mt-4">
        ...
        @if ($tool && $lim)
            <div class="md:inline-flex
                                        mt-3 md:mt-6 mb-2 justify-center pb-5">
                <div class="text-xs md:text-sm text-gray-600 md:mr-3 md:my-auto">
                ...
                <div class="mt-2 md:mt-0 md:mr-6 md:ml-0 inline-flex text-sm md:text-base">
                    ...
                    <ul class="mx-1.5 my-auto" style="list-style-type: none;">
                        ...
                        @else
                            ...
                            ?>
                            @if ($ilf > 1)
                                <li class="font-semibold float-left ml-1.5 text-gray-800">...
                                </li>
                            @endif
                            @for ($i = $ilf; $i <= $ill; $i++)
                                <li
                            ...
                            @if ($ilf < $prop['total_pages'])
                                <li class="font-semibold float-left mr-1.5 text-gray-300">...
                                </li>
                            @endif
                        @endif
                    </ul>
