...
<body>
            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="flex items-center lg:order-2">
                    <a href="{{ route('login') }}"
                        ...
                        in</a>
                    <a href="#"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 focus:outline-none">Memulai</a>
    ...
    <footer class="p-4 bg-gray-50 sm:p-6">
        <div class="mx-auto max-w-screen-xl">
            <h2 class="mb-4 text-3xl font-bold tracking-tight leading-tight text-gray-900 lg:mb-8 md:text-4xl">Contact
                Us</h2>
            <div class="md:flex md:justify-between">
                <div>
                    <div class="flex gap-x-10">
                        <div>
                            <h2
                                class="mb-4 text-1xl font-bold tracking-tight leading-tight text-gray-900 lg:mb-8 md:text-2xl">
                                Head Office</h2>
                            <div class="mb-6 md:mb-0">
                                PT Krakatau Bandar Samudera<br>
                                Jl. Raya Anyer Km 13 Cigading<br>
                                Cilegon 42445, Banten - Indonesia<br>
                                Telepon: +62 254 - 311121 (Hunting)<br>
                                Fax: +62 254 - 311178
                            </div>
                        </div>
                        <div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center">© 2022 <a href="https://karakatauport.id"
                        class="hover:underline">Krakatau International Port</a>. All Rights Reserved.
                </span>
