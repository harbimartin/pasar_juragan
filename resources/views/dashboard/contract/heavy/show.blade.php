...
@section('content')
    @php
        $column = [
            ...
            'juragan_a2b_id' => ['name' => 'Juragan Alat Berat', 'type' => 'Select', 'val' => ['provider_name'], 'api' => 'a2b', 'full' => true],
    ...
    @endphp
    <x-update unique="kontrak-a2b" :column="$column" title="Kontrak Barang" :data="$data" burl="none"
        route="dashboard.kontrak-alatberat" :select="$select" idk="id" :detail="$detail">
        ...
        <x-popup-header>
            ...
            <x-slot name="submit">
                <x-popup-submit name="Propose" key="propose" color="blue" route="dashboard.kontrak-a2b"></x-popup-submit>
            </x-slot>
        </x-popup-header>
    </x-update>
    @php
