...
@section('content')
    <?php
    $table_a2b = json_encode([
        'index' => ['name' => 'No.', 'type' => 'Index'],
        'juragan_a2b' => ['name' => 'Juragan Alat Berat', 'type' => 'SString', 'child' => ['provider_name'], 'full' => true],
    ...
    ?>
    <x-table title="Daftar Kontrak" :column="$table_a2b" :datas="$data" :prop="$prop">
    </x-table>
@endsection
