...
@section('content')
    @php
        $column = [
            'juragan_a2b_id' => ['name' => 'Juragan Angkutan', 'type' => 'Select', 'val' => ['provider_name'], 'api' => 'a2b', 'full' => true],
    ...
    <x-add unique="contract_regist" :column="$column" title="Tambah Kontrak Alat Berat" :select="$select" idk="id">
    </x-add>
@endsection
