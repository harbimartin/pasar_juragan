...
@section('content')
    @php
        ...
        $column = [
            ...
            'comp_logo' => ['name' => 'Upload Logo', 'type' => 'Upload', 'key'=>'comp_logo', 'folder'=>'comp_logo', 'full' => true]
        ];
        $column = json_encode($column);
    @endphp
    <x-update unique="profile_user" :column="$column" title="Profil Perusahaan" :data="$data" burl="none" :select="$select">
    </x-update>
@endsection
