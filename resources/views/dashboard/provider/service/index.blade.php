...
@section('tab-content')
    @if (!$detail)
        ...
        <x-add unique="provider" :column="$column_service" title="Tambah Service Juragan" :data="$data" :select="$select"
            idk="id">
        </x-add>
    @endif
    ...
    $table_service = json_encode([
        ...
        'act' => $detail ? null : ['name' => 'Action', 'type' => 'Edit', 'route' => 'dashboard.profile-company.service.edit', 'align' => 'center', 'sort' => false],
    ]);
    ?>
