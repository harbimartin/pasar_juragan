...
@section('content')
    @php
        $column = [
            ...
            'wh_name' => ['name' => 'Nama', 'type' => 'String', 'full' => true, 'def' => $data->comp_name],
            'wh_npwp' => ['name' => 'NPWP', 'type' => 'String', 'full' => true, 'def' => $data->comp_npwp],
            'wh_website' => ['name' => 'Website', 'type' => 'String', 'full' => true, 'def' => $data->comp_website],
